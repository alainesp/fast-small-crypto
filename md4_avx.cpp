...
extern "C" void md4_block_avx_x1(simd::Vec128u32 state[4], const simd::Vec128u32 block[16]) noexcept
{
...
extern "C" void md4_block_avx_x2(simd::Vec128u32 state[8], const simd::Vec128u32 block[32]) noexcept
{
...
extern "C" void md4_block_avx_x4(simd::Vec128u32 state[16], const simd::Vec128u32 block[64]) noexcept
{
...
extern "C" void md4_block_avx2_x1(simd::Vec256u32 state[4], const simd::Vec256u32 block[16]) noexcept
{
	simd::Vec256u32 a, b, c, d, t, tt;
...
extern "C" void md4_block_avx2_x2(simd::Vec256u32 state[8], const simd::Vec256u32 block[32]) noexcept
{
	simd::Vec256u32 a0, a1, b0, b1, c0, c1, d0, d1, t0, t1, tt0, tt1;
...
{
	simd::Vec256u32 a0, a1, a2, b0, b1, b2, c0, c1, c2, d0, d1, d2, t0, t1, t2, tt0, tt1, tt2;
...
extern "C" void md4_block_avx2_x4(simd::Vec256u32 state[16], const simd::Vec256u32 block[64]) noexcept
{
	simd::Vec256u32 a0, a1, a2, a3, b0, b1, b2, b3, c0, c1, c2, c3, d0, d1, d2, d3, t0, t1, t2, t3, tt0, tt1, tt2, tt3;
...
extern "C" void md4_block_avx512_x1(simd::Vec512u32 state[4], const simd::Vec512u32 block[16]) noexcept
{
	simd::Vec512u32 a, b, c, d, t, tt;
...
extern "C" void md4_block_avx512_x2(simd::Vec512u32 state[8], const simd::Vec512u32 block[32]) noexcept
{
	simd::Vec512u32 a0, a1, b0, b1, c0, c1, d0, d1, t0, t1, tt0, tt1;
...
extern "C" void md4_block_avx512_x3(simd::Vec512u32 state[12], const simd::Vec512u32 block[48]) noexcept
{
	simd::Vec512u32 a0, a1, a2, b0, b1, b2, c0, c1, c2, d0, d1, d2, t0, t1, t2, tt0, tt1, tt2;
...
{
	simd::Vec512u32 a0, a1, a2, a3, b0, b1, b2, b3, c0, c1, c2, c3, d0, d1, d2, d3, t0, t1, t2, t3, tt0, tt1, tt2, tt3;
